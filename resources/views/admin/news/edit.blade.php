...
@section('title', 'News Content edit')
@section('body')
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" id="simpleinput" name="name" class="form-control" value="{{ $new['name'] }}" required>
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea name="description" class="form-control" id="validationTextarea" >{{ $new['description'] }}</textarea>
                  </div>
                  <div class="form-group mb-3">
