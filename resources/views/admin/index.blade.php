                            ...
                            <div class="card-body" data-simplebar
                                ...
                                <div class="pb-3 timeline-item item-warning">
                                    <div class="pl-5">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col"><img src="{{ url('resources/admin') }}/assets/products/p1.jpg" alt="..."
                                                    class="img-fluid rounded"></div>
                                            <div class="col"><img src="{{ url('resources/admin') }}/assets/products/p2.jpg" alt="..."
                                                    class="img-fluid rounded"></div>
                                            <div class="col"><img src="{{ url('resources/admin') }}/assets/products/p3.jpg" alt="..."
                                                    class="img-fluid rounded"></div>
                                            <div class="col"><img src="{{ url('resources/admin') }}/assets/products/p4.jpg" alt="..."
                                                    class="img-fluid rounded"></div>
                                        </div>
                                            ...
                                            <li>
                                                <a href="#!" class="avatar avatar-sm">
                                                    <img alt="..." class="avatar-img rounded-circle"
                                                        src="{{ url('resources/admin') }}/assets/avatars/face-1.jpg">
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#!" class="avatar avatar-sm">
                                                    <img alt="..." class="avatar-img rounded-circle"
                                                        src="{{ url('resources/admin') }}/assets/avatars/face-4.jpg">
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#!" class="avatar avatar-sm">
                                                    <img alt="..." class="avatar-img rounded-circle"
                                                        src="{{ url('resources/admin') }}/assets/avatars/face-3.jpg">
                                                </a>
                                            </li>
                                        </ul>
                                        <p class="small text-muted">Front-End Development <span
